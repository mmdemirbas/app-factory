...
class FeatureFlagTest {
    ...
    fun `valid key and description creates a flag with generated id`() {
        val result = FeatureFlag.create("my_flag", "Test flag")
    ...
    fun `blank key always fails validation`() {
        val result = FeatureFlag.create("", "description")
        result.isFailure shouldBe true
    }

    @Test
    fun `key with uppercase always fails validation`() {
        val result = FeatureFlag.create("MyFlag", "description")
        result.isFailure shouldBe true
    }

    @Test
    fun `created flag respects defaultEnabled`() {
        val enabled = FeatureFlag.create("flag_on", "on", defaultEnabled = true)
        val disabled = FeatureFlag.create("flag_off", "off", defaultEnabled = false)
    ...
    fun `environment override takes precedence over default`() {
        val flag = FeatureFlag.create("f", "desc", defaultEnabled = false)
            .getOrNull()!!
